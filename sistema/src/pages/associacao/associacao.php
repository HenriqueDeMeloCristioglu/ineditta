...
$fileClassCalendario = $path . '/includes/php/class.associacao.php';
...
if (file_exists($fileClassCalendario)) {
  ...
  foreach ($sisap as $key => $value) {
    if (mb_strpos($value, "Cadastro Confederações / Federações")) {
      $indexModule = $key;
  ...
  if ($associacao->response['response_status']['status'] == 1) {

    $getAssociacao = $associacao->getAssociacao();

    if ($getAssociacao['response_status']['status'] == 1) {

      $lista = $getAssociacao['response_data']['html'];
    } else {
      $response['response_status']['status'] = 0;
      $response['response_status']['error_code'] = $error_code . __LINE__;
      $response['response_status']['msg'] = $getAssociacao['response_status']['error_code'] . '::' . $getAssociacao['response_status']['msg'];
    }
  } else {
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
...
<body onload="initKeycloak()" style="display: none;" class="horizontal-nav">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Atualização da confederação / federação</h4>
                    </div>
                      ...
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <label for="cla-inputu" class="control-label">Classe</label>
                              <input type="text" class="form-control" id="cla-inputu" placeholder="">
                            </div>

                            <div class="col-sm-6">
                              <label for="cat-inputu" class="control-label">Categoria</label>
                              <input type="text" class="form-control" id="cat-inputu" placeholder="">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-2">
                              <label for="ram-inputu" class="control-label">Ramal</label>
                              <input type="text" class="form-control" id="ram-inputu" placeholder="00000000000">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-3">
                              ...
                              <select class="form-control" id="grau-inputu">
                                <optgroup label="SELECIONE">
                            ...
                            <div class="col-sm-3">
                              <label class="control-label">Área Geoeconômica</label>
                              <select class="form-control" id="area-inputu">
                                <optgroup label="SELECIONE">
                            ...
                            <div class="col-sm-3">
                              ...
                              <select class="form-control" id="gp-inputu">
                                <optgroup label="SELECIONE">
              ...
              <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Cadastro de Confederação / Federação</h4>
                    </div>
                      ...
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <label for="cla-input" class="control-label">Classe</label>
                              <input type="text" class="form-control" id="cla-input" placeholder="">
                            </div>

                            <div class="col-sm-6">
                              <label for="cat-input" class="control-label">Categoria</label>
                              <input type="text" class="form-control" id="cat-input" placeholder="">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-2">
                              <label for="ram-input" class="control-label">Ramal</label>
                              <input type="text" class="form-control" id="ram-input" placeholder="00000000000">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-3">
                              <label class="control-label">Grau</label>
                              <select class="form-control" id="grau-input">
                                <optgroup label="SELECIONE">
                                  <option value="federação">Federação</option>
                                  <option value="confederação">Confederação</option>
                                </optgroup>
                            ...
                            <div class="col-sm-3">
                              <label class=" control-label">Grupo</label>
                              <select class="form-control" id="gp-input">
                                <optgroup label="SELECIONE">
                                  <option value="Trabalhador">Trabalhador</option>
                                  <option value="Empregador">Empregador</option>
                                </optgroup>
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-sm-offset-3">
                            <div class="btn-toolbar">
                              <a href="#" class="btn btn-primary btn-rounded" onclick="addAssociacao();">Processar</a>
            ...
            <div class="col-md-12">
              <div class="panel panel-primary">
                <div class="panel-heading">
                  <h4>Cadastro de Confederação / Federação</h4>
                  <div class="options">
  ...
  <script type='text/javascript' src="includes/js/associacao.js"></script>
