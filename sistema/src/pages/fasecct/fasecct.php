...
$fileClassCalendario = $path . '/includes/php/class.fasecct.php';
...
if (file_exists($fileClassCalendario)) {
  ...
  foreach ($sisap as $key => $value) {
    if (mb_strpos($value, "Adm - Fases Acompanhamento")) {
      $indexModule = $key;
  ...
  if ($fasecct->response['response_status']['status'] == 1) {

    $getFaseCct = $fasecct->getFaseCct();

    if ($getFaseCct['response_status']['status'] == 1) {

      $lista = $getFaseCct['response_data']['html'];
    } else {
      $response['response_status']['status'] = 0;
      $response['response_status']['error_code'] = $error_code . __LINE__;
      $response['response_status']['msg'] = $getFaseCct['response_status']['error_code'] . '::' . $getClienteUsuariosl['response_status']['msg'];
    }
  } else {
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
...
<body onload="initKeycloak()" style="display: none;" class="horizontal-nav">
                ...
                <tbody>
                  <tr>
                    <?php if ($thisModule->Criar == 1): ?>
                      <td><a data-toggle="modal" href="#myModal" class="btn default-alt  ">NOVA FASE</a></td>
                    <?php else: ?>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Atualização da Fase</h4>
                    </div>
                      ...
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label for="fase-inputu" class="col-sm-3 control-label">Fase</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="fase-inputu" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="pri-inputu" class="col-sm-3 control-label">Prioridade</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="pri-inputu" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="per-inputu" class="col-sm-3 control-label">Periodicidade</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="per-inputu" placeholder="">
                            </div>
                          </div>
              ...
              <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Cadastro de Fase</h4>
                    </div>
                    ...
                    <div class="modal-body">
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          <div class="form-group">
                            <label for="fase-input" class="col-sm-3 control-label">Fase</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="fase-input" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="pri-input" class="col-sm-3 control-label">Prioridade</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="pri-input" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="per-input" class="col-sm-3 control-label">Periodicidade</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="per-input" placeholder="">
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-sm-offset-3">
                            <div class="btn-toolbar">
                              <a href="#" class="btn btn-primary btn-rounded" onclick="addFaseCct();">Processar</a>
                    ...
                    <div class="jplist-panel box panel-top">
                      ...
                      <div data-control-type="drop-down" data-control-name="sort" data-control-action="sort"
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><span data-path=".title" data-order="asc" data-type="text">Fase
                              A-Z</span></li>
                          <li><span data-path=".title" data-order="desc" data-type="text">Fase Z-A</span></li>
                        </ul>
                      </div>
                      <div class="text-filter-box">
                        <div class="input-group"><span class="input-group-addon"><i
                              class="fa fa-search"></i></span><input data-path=".title" type="text" value=""
                            placeholder="Filtrar por Fase" data-control-type="textbox" data-control-name="title-filter"
                      ...
                      <div class="text-filter-box">
                        <div class="input-group"><span class="input-group-addon"><i
                            ...
                            placeholder="Filtrar por Prioridade" data-control-type="textbox"
                            data-control-name="desc-filter" data-control-action="filter" class="form-control" />
                        </div>
                      </div>
                    </div>
  ...
  <script type='text/javascript' src="includes/js/fasecct.js"></script>
