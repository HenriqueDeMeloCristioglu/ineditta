	...
	$.ajax(
		{
			...
			,dataType: "json"
			,data: {
				"module": "confederacaopatro", 
				"action": "addConfederacaoPatro",
...
function updateConfederacaoPatro(id_confpatro){
	...
	$.ajax(
		{
			...
			,data: {
				"module": "confederacaopatro", 
				"action": "updateConfederacaoPatro",
				"nome-input": $("#nome-inputu").val(),
				"id_confpatro": id_confpatro
...
$('#btn-atualizar').on('click', function() {
  ...
  updateConfederacaoPatro(id);
});

function getByIdConfederacaoPatro(id_confpatro){
	...
	$.ajax(
		{
			...
			,data: {
				"module": "confederacaopatro", 
				"action": "getByIdConfederacaoPatro",
				"id_confpatro": id_confpatro
			...
			,success: function (data) {
				...
				$("#nome-inputu").val( data.response_data.confpatro );
				$("#id-inputu").val( data.response_data.id_confpatro );
