...
$fileClassFedemp = $path . '/includes/php/class.confederacaopatro.php';

if (file_exists($fileClassFedemp)) {

  include_once($fileClassFedemp);

  $confederacaopatro = new confederacaopatro();

  if ($confederacaopatro->response['response_status']['status'] == 1) {

    $getConfederacaoPatro = $confederacaopatro->getConfederacaoPatro();

    if ($getConfederacaoPatro['response_status']['status'] == 1) {

      $lista = $getConfederacaoPatro['response_data']['html'];
    } else {
      $response['response_status']['status'] = 0;
      $response['response_status']['error_code'] = $error_code . __LINE__;
      $response['response_status']['msg'] = $getConfederacaoPatro['response_status']['error_code'] . '::' . $getClienteUsuariosl['response_status']['msg'];
    }
  } else {
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
    $response['response_status']['msg'] = $confederacaopatro->response['response_status']['error_code'] . '::' . $configform->response['response_status']['msg'];
  }
} else {
  $response['response_status']['status'] = 0;
  $response['response_status']['error_code'] = $error_code . __LINE__;
...
<body class="horizontal-nav">
          ...
          <div class="row" style="display: flex;">
            ...
            <div class="col-md-11 content_container">
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    <td><a data-toggle="modal" href="#myModal" class="btn default-alt  ">NOVA CONFEDERAÇÃO PATRONAL</a>
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Atualização de Confederação patronal</h4>
                    </div>
              ...
              <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Cadastro de Confederação patronal</h4>
                    </div>
                          ...
                          <div class="col-sm-6 col-sm-offset-3">
                            <div class="btn-toolbar">
                              <a href="#" class="btn btn-primary btn-rounded"
                                onclick="addConfederacaoPatro();">Processar</a>
              ...
              <div class="panel panel-sky">
                <div class="panel-heading">
                  <h4>Cadastro de Confederação patronal</h4>
                  <div class="options">
                ...
                <div class="panel-body collapse in">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <thead>
                      <tr>
                        <th></th>
                        <th>Número Confederação Patronal</th>
                        <th>Nome</th>
                      </tr>
                    </thead>
                    <tbody>
  ...
  <script type='text/javascript' src="includes/js/confederacaopatro.js"></script>
