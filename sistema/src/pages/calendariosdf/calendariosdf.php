...
$fileClassCalendario = $path . '/includes/php/class.calendariosdf.php';

if (file_exists($fileClassCalendario)) {

  include_once($fileClassCalendario);

  $calendariosdf = new calendariosdf();

  if ($calendariosdf->response['response_status']['status'] == 1) {

    $getCalendarioSdf = $calendariosdf->getCalendarioSdf();

    if ($getCalendarioSdf['response_status']['status'] == 1) {

      $lista = $getCalendarioSdf['response_data']['html'];
    } else {
      $response['response_status']['status'] = 0;
      $response['response_status']['error_code'] = $error_code . __LINE__;
      $response['response_status']['msg'] = $getCalendarioSdf['response_status']['error_code'] . '::' . $getClienteUsuariosl['response_status']['msg'];
    }
  } else {
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
...
<body class="horizontal-nav">
                      ...
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <label for="abr-inputu" class="control-label">Abrangência</label>
                              <input type="text" class="form-control" id="abr-inputu" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                      ...
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <label for="abr-input" class="control-label">Abrangência</label>
                              <input type="text" class="form-control" id="abr-input" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="col-sm-6 col-sm-offset-3">
                            <div class="btn-toolbar">
                              <a href="#" class="btn btn-primary btn-rounded"
                                onclick="addCalendarioSdf();">Processar</a>
  ...
  <script type='text/javascript' src="includes/js/calendariosdf.js"></script>
