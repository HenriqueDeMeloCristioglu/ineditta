...
$fileClausula = $path . '/includes/php/class.grupoclausula.php';

if (file_exists($fileClausula)) {

  include_once($fileClausula);
  ...
  foreach ($sisap as $key => $value) {
    if (mb_strpos($value, "Adm - Grupo Cláusula")) {
      $indexModule = $key;
  ...
  $grupoclausula = new grupoclausula();

  if ($grupoclausula->response['response_status']['status'] == 1) {

    $getGrupoClausula = $grupoclausula->getGrupoClausula();

    if ($getGrupoClausula['response_status']['status'] == 1) {

      $lista = $getGrupoClausula['response_data']['html'];
    } else {
      $response['response_status']['status'] = 0;
      $response['response_status']['error_code'] = $error_code . __LINE__;
      $response['response_status']['msg'] = $getGrupoClausula['response_status']['error_code'] . '::' . $getGrupoClausula['response_status']['msg'];
    }
  } else {
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
    $response['response_status']['msg'] = $grupoclausula->response['response_status']['error_code'] . '::' . $configform->response['response_status']['msg'];
  }
} else {
  $response['response_status']['status'] = 0;
  $response['response_status']['error_code'] = $error_code . __LINE__;
  $response['response_status']['msg'] = 'Não foi possível encontrar o arquivo (class.grupoclausula).';
}
...
<body onload="initKeycloak()" style="display: none;" class="horizontal-nav">
                ...
                <tbody>
                  <tr>
                    <?php if ($thisModule->Criar == 1): ?>
                      <td><a data-toggle="modal" href="#myModal" class="btn default-alt  ">NOVO GRUPO CLÁUSULA</a></td>
                    <?php else: ?>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Atualização de Grupo Cláusula</h4>
                    </div>
                      ...
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label for="gcla-inputu" class="col-sm-3 control-label">Grupo Cláusula</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="gcla-inputu" placeholder="">
                            </div>
                          </div>
              ...
              <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Cadastro de Grupos</h4>
                    </div>
                    ...
                    <div class="modal-body">
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          <div class="form-group">
                            <label for="gcla-inputc" class="col-sm-3 control-label">Grupo Cláusula</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="gcla-inputc" placeholder="">
                            </div>
                          </div>
                        </form>
                        <!-- Tratar buttons de jhvalidações -->
                        <div class="row">
                          <div class="col-sm-6 col-sm-offset-3">
                            <div class="btn-toolbar">
                              <a href="#" class="btn btn-primary btn-rounded" onclick="addGrClaus();">Processar</a>
                    ...
                    <div class="jplist-panel box panel-top">
                      ...
                      <div class="text-filter-box">
                        <div class="input-group"><span class="input-group-addon"><i
                            ...
                            placeholder="Filtrar por Grupo" data-control-type="textbox" data-control-name="title-filter"
  ...
  <script type='text/javascript' src="includes/js/grupoclausula.js"></script>
