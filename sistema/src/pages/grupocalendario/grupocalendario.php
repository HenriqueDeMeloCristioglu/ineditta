...
$fileDatas = $path . '/includes/php/class.grupocalendario.php';

if (file_exists($fileDatas)) {

  include_once($fileDatas);

  $grupocalendario = new grupocalendario();

  if ($grupocalendario->response['response_status']['status'] == 1) {

    $getGrupoCalendario = $grupocalendario->getGrupoCalendario();

    if ($getGrupoCalendario['response_status']['status'] == 1) {

      $lista = $getGrupoCalendario['response_data']['html'];
    } else {
      $response['response_status']['status'] = 0;
      $response['response_status']['error_code'] = $error_code . __LINE__;
      $response['response_status']['msg'] = $getGrupoCalendario['response_status']['error_code'] . '::' . $getGrupoCalendario['response_status']['msg'];
    }
  } else {
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
    $response['response_status']['msg'] = $grupocalendario->response['response_status']['error_code'] . '::' . $configform->response['response_status']['msg'];
  }
} else {
  $response['response_status']['status'] = 0;
  $response['response_status']['error_code'] = $error_code . __LINE__;
  $response['response_status']['msg'] = 'Não foi possível encontrar o arquivo (class.grupocalendario).';
}
...
<body class="horizontal-nav">
          ...
          <div class="row" style="display: flex;">
            ...
            <div class="col-md-11 content_container">
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    <td><a data-toggle="modal" href="#myModal" class="btn default-alt  ">NOVO GRUPO</a></td>
                  </tr>
                </tbody>
              </table>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Atualização dos Grupos</h4>
                    </div>
                      ...
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label for="cal-inputu" class="col-sm-3 control-label">Grupo Calendário</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="cal-inputu" placeholder="">
                            </div>
                          </div>
              ...
              <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Cadastro dos Grupos</h4>
                    </div>
                    ...
                    <div class="modal-body">
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          <div class="form-group">
                            <label for="cal-inputc" class="col-sm-3 control-label">Grupo Calendário</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="cal-inputc" placeholder="">
                            </div>
                          </div>
                        </form>
                          ...
                          <div class="col-sm-6 col-sm-offset-3">
                            <div class="btn-toolbar">
                              <a href="#" class="btn btn-primary btn-rounded"
                                onclick="addGrupoCalendario();">Processar</a>
              ...
              <div class="panel panel-sky">
                <div class="panel-heading">
                  <h4>Cadastro de Calendário de Grupos</h4>
                  <div class="options">
  ...
  <script type='text/javascript' src="includes/js/grupocalendario.js"></script>
