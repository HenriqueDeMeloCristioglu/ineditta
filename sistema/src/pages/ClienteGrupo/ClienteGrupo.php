...
$fileCliente = $path . '/includes/php/class.clientegrupo.php';

if (file_exists($fileCliente)) {

    include_once $fileCliente;
    ...
    foreach ($sisap as $key => $value) {
        if (mb_strpos($value, "Cliente Grupo Econômico")) {
            $indexModule = $key;
    ...
    if ($clientegrupo->response['response_status']['status'] == 1) {

        $getClienteGrupo = $clientegrupo->getClienteGrupo();

        if ($getClienteGrupo['response_status']['status'] == 1) {

            $lista = $getClienteGrupo['response_data']['html'];
        } else {
            $response['response_status']['status'] = 0;
            $response['response_status']['error_code'] = $error_code . __LINE__;
            $response['response_status']['msg'] = $getClienteGrupo['response_status']['error_code'] . '::' . $getClienteGrupo['response_status']['msg'];
        }
    } else {
        $response['response_status']['status'] = 0;
        $response['response_status']['error_code'] = $error_code . __LINE__;
        $response['response_status']['msg'] = $clientegrupo->response['response_status']['error_code'] . '::' . $configform->response['response_status']['msg'];
    }
} else {
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
    $response['response_status']['msg'] = 'Não foi possível encontrar o arquivo (class.clientegrupo).';
}
...
<body onload="initKeycloak()" style="display: none;" class="horizontal-nav">
                                ...
                                <tbody>
                                    <tr>
                                        <?php if ($thisModule->Criar == 1): ?>
                                            <td><a data-toggle="modal" href="#myModal" class="btn default-alt  ">NOVO GRUPO
                                                    ECONÔMICO</a></td>
                                        <?php else: ?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Atualização do Grupo Econômico</h4>
                                        </div>
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="grupo-inputu" class="col-sm-3 control-label">Grupo
                                                            Econômico</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="grupo-inputu"
                                                                placeholder="">
                                                        </div>
                                                    </div>
                                                    <form class="form-horizontal">
                                                        <input type="hidden" id="id-inputu" value="1">
                                                        <div class="form-group">
                                                            <label for="logo-inputu" class="col-sm-3 control-label">Logo
                                                                do Grupo</label>
                                                            <div class="col-sm-8">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="panel panel-primary">
                                                ...
                                                <form class="form-horizontal">
                                                    <div class="form-group">
                                                        <label for="grupo-inputc" class="col-sm-3 control-label">Grupo
                                                            Econômico</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="grupo-inputc"
                                                                placeholder="">
                                                        </div>
                                                    </div>
                                                </form>
                                                <form class="form-horizontal">
                                                    <div class="form-group">
                                                        <label for="logo-inputc" class="col-sm-3 control-label">Logo do
                                                            Grupo</label>
                                                        <div class="col-sm-8">
                                                            <input type="file" class="form-control-file"
                                                                id="logo-inputc">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h4>Cadastro de Grupo Econômico</h4>
                                    <div class="options">
                                            ...
                                            <div data-control-type="drop-down" data-control-name="sort"
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><span data-path=".title" data-order="desc"
                                                            data-type="text">Grupo Z-A</span></li>
                                                </ul>
                                            </div>
                                            <div class="text-filter-box">
                                                <div class="input-group"><span class="input-group-addon"><i
                                                            class="fa fa-search"></i></span><input data-path=".title"
                                                        type="text" value="" placeholder="Filtrar por Grupo Economico"
    ...
    <script type='text/javascript' src="includes/js/ClienteGrupo.js"></script>
