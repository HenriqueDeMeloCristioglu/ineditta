...
$fileClassSindical = $path . '/includes/php/class.sindicatopatronal.php';
...
if (file_exists($fileClassSindical)) {
  ...
  foreach ($sisap as $key => $value) {
    if (mb_strpos($value, "Cadastro de Sindicato Patronal")) {
      $indexModule = $key;
  ...
  $sindicatopatronal = new sindicatopatronal();

  if ($sindicatopatronal->response['response_status']['status'] == 1) {
    //$getSindicatoPatronalCampos = $sindicatopatronal->getSindicatoPatronalCampos();

    // if ($getSindicatoPatronalCampos['response_status']['status'] == 1) {

    // 	$associacao = $getSindicatoPatronalCampos['response_data']['associacao'];
    // 	$listaAssociacao = $getSindicatoPatronalCampos['response_data']['listaAssociacao'];
    // 	$listaAssociacaoUpdate = $getSindicatoPatronalCampos['response_data']['listaAssociacaoUpdate'];
    // 	$listaAssociacao1 = $getSindicatoPatronalCampos['response_data']['listaAssociacao1'];
    // 	$listaAssociacaoUpdate1 = $getSindicatoPatronalCampos['response_data']['listaAssociacaoUpdate1'];


    // 	$centralsindical = $getSindicatoPatronalCampos['response_data']['centralsindical'];
    // 	$listaCentralSindical = $getSindicatoPatronalCampos['response_data']['listaCentralSindical'];
    // 	$listaCentralSindicalUpdate = $getSindicatoPatronalCampos['response_data']['listaCentralSindicalUpdate'];

    // 	$localizacao = $getSindicatoPatronalCampos['response_data']['localizacao'];
    // 	$listaLocalizacao = $getSindicatoPatronalCampos['response_data']['listaLocalizacao'];
    // 	$listaLocalizacao2 = $getSindicatoPatronalCampos['response_data']['listaLocalizacao2'];

    // 	$listaCNAEini = $getSindicatoPatronalCampos['response_data']['listaCNAEini'];
    // 	$listaCNAEiniu = $getSindicatoPatronalCampos['response_data']['listaCNAEiniu'];
    // } else {
    // 	$response['response_status']['status'] = 0;
    // 	$response['response_status']['error_code'] = $error_code . __LINE__;
    // 	$response['response_status']['msg'] = $getSindicatoPatronalCampos['response_status']['error_code'] . '::' . $getSindicatoPatronalCampos['response_status']['msg'];
    // }
    ...
    $associacao = '';
    $listaAssociacao = '';
    $listaAssociacaoUpdate = '';
    $listaAssociacao1 = '';
    $listaAssociacaoUpdate1 = '';


    $centralsindical = '';
    $listaCentralSindical = '';
    $listaCentralSindicalUpdate = '';
    ...
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
    $response['response_status']['msg'] = $sindicatopatronal->response['response_status']['error_code'] . '::' . $configform->response['response_status']['msg'];
  }
} else {
  $response['response_status']['status'] = 0;
  $response['response_status']['error_code'] = $error_code . __LINE__;
  $response['response_status']['msg'] = 'Não foi possível encontrar o arquivo (class.sindicatopatronal).';
}
...
<head>
  ...
  <link rel="stylesheet" type='text/css' href="sindicatopatronal.css">
  ...
  <style>
    ...
    #baseTerritoriaisSelecionadastb_filter {
...
<body class="horizontal-nav">
      ...
      <div id="wrap">
        <div class="container">
          <div class="row" style="display: flex;">
            ...
            <!-- Modal localizacao -->
            <div id="localizacaoModalHidden" class="hidden modal_hidden">
              <div id="localizacaoModalHiddenContent">
                <div class="modal-body">
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-body collapse in">
                      <div class="box text-shadow">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered demo-tbl" id="localizacaotb">
                          <thead>
                            <tr>
                              <th></th>
                              <th>Código do País</th>
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" id="modalLocalizacaoCadastrarBtn" data-dismiss="modal">Seguinte</button>
                </div>
              </div>
            </div>
              ...
              <div id="baseTerritorialHistoricoModalHiddenContent">
                ...
                <div class="modal-body">
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-body collapse in">
                      <div class="box text-shadow">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered demo-tbl" id="baseTerritorialHistoricotb">
                          <thead>
                            <tr>
                              <th>Localização</th>
                              <th>Uf</th>
                      ...
                      <form class="form-horizontal">
                        ...
                        <div class="form-group">
                          <div class="col-sm-4">
                            ...
                            <input type="email" class="form-control" id="email1-input" placeholder="">
                          </div>
                          <div class="col-sm-4">
                            <label for="email2-input" class="control-label">E-mail 2</label>
                            <input type="email" class="form-control" id="email2-input" placeholder="">
                          </div>
                          <div class="col-sm-4">
                            <label for="email3-input" class="control-label">E-mail 3</label>
                            <input type="email" class="form-control" id="email3-input" placeholder="">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="col-sm-4">
                            <button id="baseTerritorialAbrirModalBtn" type="button" data-toggle="modal" data-target="#baseTerritorialModal" class="btn btn-primary btn-rounded">Definir base territorial*</button>
                          </div>

                          <div class="col-sm-4">
                            <button id="baseTerritorialHistoricoModalBtn" type="button" data-toggle="modal" data-target="#baseTerritorialHistoricoModal" class="btn btn-primary btn-rounded">Histórico da base territorial</button>
                          </div>
                        </div>
                      </form>
                    </div>
        ...
        <div class="row" style="display: flex;">
          <div class="col-md-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h4>Cadastro Sindicato Patronal</h4>
                <div class="options">
                  <a href="javascript:;" class="panel-collapse"><i class="fa fa-chevron-down"></i></a>
                </div>
              </div>
              <div class="panel-body collapse in principal-table">
                <div class="box text-shadow">
                  <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered demo-tbl" id="sindicatotb" data-order='[[ 1, "asc" ]]'>
                    <thead>
                      <tr>
                        <th>Ações</th>
                        <th>Sigla</th>
  ...
  <script type='text/javascript' src="./js/sindicatopatronal.min.js"></script>                 
</body>
