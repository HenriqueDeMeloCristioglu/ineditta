...
$fileEstruturaClausula = $path . '/includes/php/class.estruturaclausula.php';

if (file_exists($fileEstruturaClausula)) {

  include_once($fileEstruturaClausula);

  $estruturaclausula = new estruturaclausula();

  if ($estruturaclausula->response['response_status']['status'] == 1) {

    $getEstruturaClausula = $estruturaclausula->getEstruturaClausula();

    if ($getEstruturaClausula['response_status']['status'] == 1) {

      $lista = $getEstruturaClausula['response_data']['html'];
    } else {
      $response['response_status']['status'] = 0;
      $response['response_status']['error_code'] = $error_code . __LINE__;
      $response['response_status']['msg'] = $getEstruturaClausula['response_status']['error_code'] . '::' . $getEstruturaClausula['response_status']['msg'];
    }
  } else {
    $response['response_status']['status'] = 0;
    $response['response_status']['error_code'] = $error_code . __LINE__;
    $response['response_status']['msg'] = $estruturaclausula->response['response_status']['error_code'] . '::' . $configform->response['response_status']['msg'];
  }
} else {
  $response['response_status']['status'] = 0;
  $response['response_status']['error_code'] = $error_code . __LINE__;
  $response['response_status']['msg'] = 'Não foi possível encontrar o arquivo (class.estruturaclausula).';
}
...
<body onload="initKeycloak()" class="horizontal-nav">
          ...
          <div class="row" style="display: flex;">
            ...
            <div class="col-md-11 content_container">
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    <td><a data-toggle="modal" href="#myModal" class="btn default-alt  ">NOVA CLÁUSULA</a></td>
                  </tr>
                </tbody>
              </table>
                      ...
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label for="nome-inputu" class="col-sm-3 control-label">Grupo</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="nome-inputu" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="cla-inputu" class="col-sm-3 control-label">Cláusula</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="cla-inputu" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="tipo-inputu" class="col-sm-3 control-label">Tipo da Cláusula</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="tipo-inputu" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="classe-inputu" class="col-sm-3 control-label">Classe da Cláusula</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="classe-inputu" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="grupo-inputu" class="col-sm-3 control-label">Grupo</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="grupo-inputu" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="assunto-inputu" class="col-sm-3 control-label">Assunto do Calendário</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="assunto-inputu" placeholder="">
                            </div>
                          </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal">
                          <div class="form-group">
                            <label for="nome-inputc" class="col-sm-3 control-label">Grupo</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="nome-inputc" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="cla-inputc" class="col-sm-3 control-label">Cláusula</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="cla-inputc" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="tipo-inputc" class="col-sm-3 control-label">Tipo da Cláusula</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="tipo-inputc" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="classe-inputc" class="col-sm-3 control-label">Classe da Cláusula</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="classe-inputc" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="grupo-inputc" class="col-sm-3 control-label">Grupo</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="grupo-inputc" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="assunto-inputc" class="col-sm-3 control-label">Assunto do Calendário</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="assunto-inputc" placeholder="">
                            </div>
                          </div>
                        </form>
                          ...
                          <div class="col-sm-6 col-sm-offset-3">
                            <div class="btn-toolbar">
                              <a href="#" class="btn btn-primary btn-rounded"
                                onclick="addEstruturaClausula();">Processar</a>
              ...
              <div class="panel panel-sky">
                <div class="panel-heading">
                  <h4>Cadastro de Estrutura de Claúsulas</h4>
                  <div class="options">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th>Tipo da Cláusula</th>
                        <th>Classe da Cláusula</th>
                        <th>Grupo Calendário</th>
                        <th>Assunto Calendário</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php print $lista; ?>
  ...
  <script type='text/javascript' src="includes/js/estruturaclausula.js"></script>
