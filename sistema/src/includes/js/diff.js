...
var WikEdDiff = function () {
	...
	this.config = {
		...
		'stylesheet':
			...
			'.wikEdDiffFragment:hover .wikEdDiffInsertBlank { background-color: #f1aeb5; } ' +
			...
			'} ' +
			'.wikEdDiffBlock { } ' +
			'.wikEdDiffBlock0 { background-color: #f1aeb5; } ' +
			'.wikEdDiffBlock1 { background-color: #f1aeb5; } ' +
			'.wikEdDiffBlock2 { background-color: #f1aeb5; } ' +
			'.wikEdDiffBlock3 { background-color: #f1aeb5; } ' +
			'.wikEdDiffBlock4 { background-color: #f1aeb5; } ' +
			'.wikEdDiffBlock5 { background-color: #f1aeb5; } ' +
			'.wikEdDiffBlock6 { background-color: #f1aeb5; } ' +
			'.wikEdDiffBlock7 { background-color: #f1aeb5; } ' +
			'.wikEdDiffBlock8 { background-color: #f1aeb5; } ' +
			...
			'.wikEdDiffContainer { } ' +
			'.wikEdDiffFragment {' +
			'white-space: pre-wrap; background: #fff; border: #e35d6a  solid; ' +
			...
			'} ' +
			'.wikEdDiffNoChange { background: #f0f0f0; border: 1px #e35d6a solid; border-radius: 0.5em; ' +
	...
	this.diff = function ( oldString, newString ) {
		...
		if ( this.newText.text === this.oldText.text ) {
			this.html =
				...
				this.htmlEscape( this.newText.text ) +//this.config.msg['wiked-diff-empty']
