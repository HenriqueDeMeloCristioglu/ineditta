...
var WikEdDiff2 = function () {
	...
	this.config = {
		...
		'stylesheet':
			...
			// Insert
			'.wikEdDiffInsert {' +
			'font-weight: bold; background-color: #0ce783 ; ' +
			'color: #222;  ' +//border-radius: 0.25em; padding: 0.2em 1px;
			'} ' +
			'.wikEdDiffInsertBlank { background-color: #fff; } ' +
			'.novoFragmento:hover .wikEdDiffInsertBlank { background-color: #0ce783; } ' +
			

			// Delete
			// '.wikEdDiffDelete {' +
			// 'font-weight: bold; background-color: #f1aeb5; ' +
			// 'color: #222; border-radius: 0.25em; padding: 0.2em 1px; ' +
			// '} ' +
			// '.wikEdDiffDeleteBlank { background-color: #ffd064; } ' +
			// '.wikEdDiffFragment:hover .wikEdDiffDeleteBlank { background-color: #f1aeb5; } ' +
			...
			'} ' +
			'.wikEdDiffBlock { } ' +
			'.wikEdDiffBlock0 { background-color: #0ce783; } ' +
			'.wikEdDiffBlock1 { background-color: #0ce783; } ' +
			'.wikEdDiffBlock2 { background-color: #0ce783; } ' +
			'.wikEdDiffBlock3 { background-color: #0ce783; } ' +
			'.wikEdDiffBlock4 { background-color: #0ce783; } ' +
			'.wikEdDiffBlock5 { background-color: #0ce783; } ' +
			'.wikEdDiffBlock6 { background-color: #0ce783; } ' +
			'.wikEdDiffBlock7 { background-color: #0ce783; } ' +
			'.wikEdDiffBlock8 { background-color: #0ce783; } ' +
			...
			'.wikEdDiffContainer { } ' +
			'.wikEdDiffFragment {' +
			'white-space: pre-wrap; background: #fff; border: #20c997  solid; ' +
			'border-width: 0px 0px 0px 0.5em; border-radius: 0.5em; font-family: sans-serif; ' +
			'font-size: 88%; line-height: 1.6; box-shadow: 2px 2px 2px #ddd; padding: 1em; margin: 0; ' +
			'} ' +
			'.novoFragmento {' +
			'white-space: pre-wrap; background: #fff; border: #20c997  solid !important; ' +
			'border-width: 0px 0px 0px 0.5em; border-radius: 0.5em; font-family: sans-serif; ' +
			'font-size: 88%; line-height: 1.6; box-shadow: 2px 2px 2px #ddd; padding: 1em; margin: 0; ' +
			'} ' +
			
			'.wikEdDiffNoChange { background: #f0f0f0; border: 1px #20c997 solid; border-radius: 0.5em; ' +
	...
	this.config.msg = {
    'wiked-diff-empty': '',//(Não há diferença)
    'wiked-diff-same':  '',
    'wiked-diff-ins':   '',
    'wiked-diff-del':   '',
	...
	this.config.htmlCode = {
		'noChangeStart':
			'<div class="nadaDeNovo" title="' +
			this.config.msg['wiked-diff-ins'] +
			'">',//class="" wikEdDiffNoChange
		'noChangeEnd': '</div>',

		'containerStart': '<div class="wikEdDiffContainer" id="wikEdDiffContainer">',
		'containerEnd': '</div>',

		'fragmentStart': '<pre class="novoFragmento" style="white-space: pre-wrap;">',
		'fragmentEnd': '</pre>',
		'separator': '<div class="wikEdDiffSeparator"></div>',

		'insertStart':
			'<span class="wikEdDiffInsert novoInserted" title="' +
			this.config.msg['wiked-diff-ins'] +
			'">',
		'insertStartBlank':
			'<span class="wikEdDiffInsert novoInserted" title="' +
		...
		'blockStart':
			'<span class="wikEdDiffBlock novoInserted"' +
			'title="{title}" id="wikEdDiffBlock{number}"' +
			'onmouseover="wikEdDiffBlockHandler(undefined, this, \'mouseover\');">',
		'blockColoredStart':
			'<span class="wikEdDiffBlock wikEdDiffBlock wikEdDiffBlock{number} novoInserted"' +
			'title="{title}" id="wikEdDiffBlock{number}"' +
			'onmouseover="wikEdDiffBlockHandler(undefined, this, \'mouseover\');">',
		'blockEnd': '</span>',
	...
	this.diff = function ( oldString, newString ) {
		...
		this.newText = new WikEdDiff2.WikEdDiffText( newString, this );
		this.oldText = new WikEdDiff2.WikEdDiffText( oldString, this );
 ...
 * @class WikEdDiffText
 */
WikEdDiff2.WikEdDiffText = function ( text, parent ) {

	/** @var WikEdDiff2 parent Parent object for configuration settings and debugging methods */
	this.parent = parent;
	 ...
	 * @param WikEdDiff2 parent Parent, for configuration settings and debugging methods
	 */
	this.init = function () {
