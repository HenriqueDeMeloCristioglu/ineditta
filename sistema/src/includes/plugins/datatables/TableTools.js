    ...
    TableTools.prototype = {
        ...
        fnSelect: function (a) {
            if (this.s.select.type ==
                ...
                this.s.select.type == "multi" && this._fnRowSelect(a)
        },
        ...
        fnResizeRequired: function () {
            for (var a in ZeroClipboard_TableTools.clients)
                if (a) {
                    var b = ZeroClipboard_TableTools.clients[a];
                    if (typeof b.domElement != "undefined" && b.domElement.parentNode == this.dom.container && b.sized === false)
                        return true
                }
            return false
        },
        ...
        _fnCollectionShow: function (a, b) {
            ...
            if (b + g > l)
                e.style.left = l - g + "px";
            if (d + h > k)
                e.style.top = d - h - f(a).outerHeight() + "px";
                    ...
                    if (this.parentNode == b.nTBody)
                        if (b.oInstance.fnGetData(this) !==
                            ...
                            if (a.fnIsSelected(this))
                                ...
                                a.s.select.type == "multi" && a._fnRowSelect(this, c)
                });
        ...
        _fnColumnTargets: function (a) {
            ...
            if (typeof a == "object") {
                ...
                i = 0;
                for (iLen = c.aoColumns.length; i < iLen; i++)
                    b.push(c.aoColumns[i].bSortable ? true : false)
            } else {
                i = 0;
                for (iLen = c.aoColumns.length; i < iLen; i++)
                    b.push(true)
        ...
        _fnGetDataTablesData: function (a) {
            ...
            if (this.s.select.type !== "none" && d && e.length !== 0) {
                ...
                for (c = e.length; b < c; b++)
                    n.push(l.oInstance.fnGetPosition(e[b]))
            }
            d =
                0;
