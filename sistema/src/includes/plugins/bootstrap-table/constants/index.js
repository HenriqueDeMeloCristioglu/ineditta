...
const EN = {
  ...
  formatRecordsPerPage (pageNumber) {
    return `${pageNumber} linhas por página`
  },
  formatShowingRows (pageFrom, pageTo, totalRows, totalNotFiltered) {
    if (totalNotFiltered !== undefined && totalNotFiltered > 0 && totalNotFiltered > totalRows) {
      return `Mostrando de ${pageFrom} até ${pageTo} de ${totalRows} linhas (filtered from ${totalNotFiltered} total rows)`
    }

    return `Mostrando de ${pageFrom} até ${pageTo} de ${totalRows} linhas`
  },
