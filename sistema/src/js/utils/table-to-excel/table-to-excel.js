...
$.fn.tblToExcel = function () {
  ...
  if (this.length > 1) {
    $("body").append(
      '<div id="tbl-tnv-back" style="position: fixed; z-index: 1;padding-top: 100px;left: 0;top: 0;width: 100%;height: 100%;overflow: auto;background-color: rgb(0,0,0);background-color: rgba(0,0,0,0.4);">' +
  ...
  var tableToExcel = (function () {
    ...
    return function (table, name) {
      ...
      if (elm) {
        ...
        $("#tbl-tnv-excel").append(
          '<a id="tbl-tnv-anch" style="background-color: #4CAF50;border: none;\n' +
            "color: white;" +
            "padding: 15px 32px;" +
            "text-align: center;" +
