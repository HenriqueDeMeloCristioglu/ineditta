...
{
    public class DirigentePatronalVwMap : IEntityTypeConfiguration<DirigentePatronalVw>
    {
        public void Configure(EntityTypeBuilder<DirigentePatronalVw> builder)
        {
            builder.ToView("dirigente_patronal_vw");
            ...
            builder.Property(e => e.SindpId).HasColumnName("sindp_id");
        }
    }
}
