...
{
    internal sealed class ComparativoMapaSindicalItemVwMap : IEntityTypeConfiguration<ComparativoMapaSindicalItemVw>
    {
        public void Configure(EntityTypeBuilder<ComparativoMapaSindicalItemVw> builder)
        {
            builder.ToView("comparativo_mapa_sindical_item_vw");
            ...
            builder.Property(p => p.ExibeComparativoMapaSindical)
                .HasColumnName("exibe_comparativo_mapa_sindical");

            builder.Property(p => p.ClausulaInformacaoNumero)
