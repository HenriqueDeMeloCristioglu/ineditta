...
namespace Ineditta.Repository.Migrations
{
    ...
    public partial class v88 : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"drop view comparativo_mapa_sindical_principal_vw;");
            ...
            migrationBuilder.Sql(@"CREATE OR REPLACE VIEW comparativo_mapa_sindical_principal_vw AS
                                select
                                    ...
                                    JSON_UNQUOTE(JSON_EXTRACT(dct.sind_patronal, '$[*].sigla')) siglas_sindicatos_patronais,
                                    JSON_UNQUOTE(JSON_EXTRACT(dct.sind_laboral , '$[*].sigla')) siglas_sindicatos_laborais,
                                    JSON_UNQUOTE(JSON_EXTRACT(dct.cnae_doc  , '$[*].subclasse')) cnaes_subclasses
                                from
                                    doc_sind dct
