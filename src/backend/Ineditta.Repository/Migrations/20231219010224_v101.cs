        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE OR REPLACE VIEW sindicato_vw AS
	                                    select 
	                                        ...
	                                        bemp.dataneg
	                                        from sind_emp sinde 
	                                        left join base_territorialsindemp bemp on bemp.sind_empregados_id_sinde1 = sinde.id_sinde 
	                                        ...
	                                        left join sind_patr sindp on sindp.id_sindp = bpatr.sind_patronal_id_sindp
