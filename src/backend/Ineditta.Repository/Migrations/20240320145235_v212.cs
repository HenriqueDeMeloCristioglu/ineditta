...
namespace Ineditta.Repository.Migrations
{
    ...
    public partial class v212 : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"CREATE OR REPLACE VIEW clausula_geral_vw AS
                    select
                    ...
                    from
                        (
                            ...
                            where cg.consta_no_documento = 1
                            group by cg.doc_sind_id_documento
                        ) x
                    left join doc_sind ds on ds.id_doc = x.documento_id
                    left join tipo_doc tp on tp.idtipo_doc = ds.tipo_doc_idtipo_doc;");

            migrationBuilder.Sql(@"update modulos set modulos = 'Mapa sindical – Busca rápida'
                where id_modulos = 64");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"update modulos set modulos = 'Busca rapida'
                where id_modulos = 64");
        }
    }
}
