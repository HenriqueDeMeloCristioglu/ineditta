    ...
    public partial class v133 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateIndex(
                name: "ix001_documento_sindicato_laboral_tb",
                table: "documento_sindicato_laboral_tb",
                columns: new[] { "documento_id", "sindicato_laboral_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix001_documento_sindicato_patronal_tb",
                table: "documento_sindicato_patronal_tb",
                columns: new[] { "documento_id", "sindicato_patronal_id" },
                unique: true);

            migrationBuilder.Sql(@"
                DROP PROCEDURE IF EXISTS obter_documento_ultimo_ano_sindicatos_laborais;
            ");
        ...
        {
            migrationBuilder.Sql(@"
                ALTER TABLE documento_sindicato_patronal_tb DROP INDEX ix001_documento_sindicato_patronal_tb;
                ALTER TABLE documento_sindicato_laboral_tb DROP INDEX ix001_documento_sindicato_laboral_tb;
            ");
