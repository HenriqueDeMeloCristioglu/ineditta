            ...
            modelBuilder.Entity("Ineditta.Application.Clausulas.Entities.ClausulaGeral", b =>
                {
                    ...
                    b.Property<long?>("ResponsavelProcessamento")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ineditta.Application.InformacoesAdicionais.Sisap.Entities.InformacaoAdicionalSisap", b =>
                {
                    ...
                    b.HasIndex(new[] { "ClausulaGeralId" }, "clausula_geral_id_clau_ibfk_1");

                    b.HasIndex(new[] { "EstruturaClausulaId" }, "estrutura_clausula_id_estruturaclausula_ibfk_2");

                    b.HasIndex(new[] { "TipoinformacaoadicionalId" }, "info_adicional_ibfk_2_idx");
            ...
            modelBuilder.Entity("Ineditta.Application.InformacoesAdicionais.Sisap.Entities.InformacaoAdicionalSisap", b =>
                {
                    ...
                    b.HasOne("Ineditta.Repository.Models.InformacaoAdicionalGrupo", null)
                        .WithMany()
                        .HasForeignKey("InforamcacaoAdicionalGrupoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_clausula_geral_estrutura_clausula_x_informacao_adicional_grupo");
