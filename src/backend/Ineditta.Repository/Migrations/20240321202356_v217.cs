...
namespace Ineditta.Repository.Migrations
{
    ...
    public partial class v217 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"UPDATE clausula_geral set resumo_status = 1
                                   where resumo_status is null;");

            migrationBuilder.Sql(@"CREATE OR REPLACE VIEW clausulas_vw AS
                                select
                                    cgt.id_clau AS clausula_id,
                                    cgt.tex_clau AS clausula_texto,
                                    cgt.resumo_status resumo_status_id,
	                                    case cgt.resumo_status
	                                    when 1 then 'Não Resumida'
	                                    when 2 then 'Resumindo'
	                                    when 3 then 'Resumido'
	                                end as resumo_status,
