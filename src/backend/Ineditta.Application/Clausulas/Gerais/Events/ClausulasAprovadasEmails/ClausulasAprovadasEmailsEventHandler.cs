...
using Ineditta.Application.Clausulas.Gerais.Services.ClausulasEmailService;
...
#pragma warning disable CA1711 // Identifiers should not have incorrect suffix
    public class ClausulasAprovadasEmailsEventHandler : IRequestHandler<ClausulasAprovadasEmailsEvent>
#pragma warning restore CA1711 // Identifiers should not have incorrect suffix
    {
        private readonly IClausulasEmailService _clausulasEmailService;
        ...
        public async ValueTask<Result> Handle(ClausulasAprovadasEmailsEvent message, CancellationToken cancellationToken = default)
        {
            ...
            var emailInfo = documentoSisapEmailBuilder.Build<DocumentoClausulasLiberadasEmailDto>();
            ...
            var resultEnvioEmail = await _clausulasEmailService.EnviarEmailClausulasAprovadasAsync(emailInfo, documento.Id, emails, cancellationToken);
